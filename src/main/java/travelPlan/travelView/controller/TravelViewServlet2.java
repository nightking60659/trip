package travelPlan.travelView.controller;
...
public class TravelViewServlet2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String viewAddr =request.getParameter("viewAddr");
		String viewPhone =request.getParameter("viewPhone");
